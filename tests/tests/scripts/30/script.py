...
with torch.no_grad():
    ...
    y = torch.load("../../data/surface_aligned_dos1.pt")
    feats = torch.load("../../data/surface_kernel_30.pt")
    index_train, index_test = surface_holdout_train_index, surface_holdout_test_index
    regularization_value = 0.01
    kMM = torch.load("../../data/surface_kMM_30.pt")


weights, loss_dos, test_loss_dos, opt_shift_train, opt_shift_test = kernel_reg_train_Ad(feats, y, index_train, index_test, kMM, regularization_value, 10000, 16, 1e-3) 
