...
with torch.no_grad():
    ...
    feats = torch.load("../../data/surface_soap.pt")
    index_train, index_test = surface_holdout_train_index, surface_holdout_test_index
    regularization_value = 0.1



weights, loss_dos, test_loss_dos, opt_shift_train, opt_shift_test = normal_reg_train_Ad(feats, y, index_train, index_test, regularization_value, 10000, 16, 1e-3) 
