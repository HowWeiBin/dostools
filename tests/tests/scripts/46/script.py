...
with torch.no_grad():
    ...
    y = torch.load("../../data/bulk_ldos1.pt")
    feats = torch.load("../../data/bulk_kernel_100.pt")
    index_train, index_test = bulk_biased_train_index, bulk_biased_test_index
    regularization_value = 0.1
    kMM = torch.load("../../data/bulk_kMM_100.pt")
