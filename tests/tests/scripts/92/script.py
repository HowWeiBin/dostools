...
with torch.no_grad():
    ...
    y = torch.load("../../data/total_aligned_dos1.pt")
    feats = torch.load("../../data/total_kernel_150.pt")
    index_train, index_test = total_biased_train_index, total_biased_test_index
    regularization_value = 0.1
    kMM = torch.load("../../data/total_kMM_150.pt")
